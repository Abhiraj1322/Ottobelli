...
>
  ...
  {/* ── Subcategory Cards ── */}
  <div className="px-6 sm:px-12 md:px-16 py-12 md:py-16">
    <motion.p
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    {isLoading ? (
      ...
      <div
        className="flex gap-4 overflow-x-auto pb-4 -mx-6 px-6 sm:mx-0 sm:px-0 snap-x snap-mandatory scrollbar-none"
      ...
      >
        {categories.map((cat, i) => (
          <motion.div
            ...
            className="flex-shrink-0 cursor-pointer relative overflow-hidden snap-start"
            style={{
              width: "200px",
              height: "300px",
          ...
          >
            ...
            {/* Category number */}
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold opacity-10 pointer-events-none"
              style={{
                fontFamily: "'Playfair Display', serif",
                fontSize: "80px",
                color: "#FFFFFF",
      ...
      <div
        className="mx-6 sm:mx-12 md:mx-16 mb-16 p-8 md:p-12"
        style={{
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {[
            ...
            >
              <div className="w-6 h-px mb-4 md:mb-5" style={{ background: "#C8A96E" }} />
              <h3
