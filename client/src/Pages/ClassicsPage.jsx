  ...
  <div
    ...
    >
      ...
      >
        ...
        {/* Dark overlay for Hero to preserve contrast over photo */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(to right, rgba(18,16,12,0.92) 40%, rgba(18,16,12,0.45) 100%)",
          }}
        />
      ...
      <div className="w-full bg-[#FDFBF7] px-6 sm:px-12 md:px-16 py-16 border-t border-b border-[#E8E2D5]">
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          {[
            {
              ...
              desc: "Every pattern is cut from individual human inputs. Built distinctively to complement and contour your physical silhouette seamlessly.",
            },
            {
            ...
            >
              <div className="w-6 h-px mb-5 bg-[#C5A059]" />
